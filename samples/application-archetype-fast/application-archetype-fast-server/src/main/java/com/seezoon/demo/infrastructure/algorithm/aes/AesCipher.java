package com.seezoon.demo.infrastructure.algorithm.aes;
...
import com.seezoon.demo.infrastructure.algorithm.AlgorithmException;
...
public class AesCipher {
    ...
    /**
     * 默认算法 {@link AesCipher#AesCipher(String, byte[], byte[])}
     *
     * @param key
     * @param iv
     * @see AesAlgorithm#AES_CBC_PKCS5PADDING
     */
