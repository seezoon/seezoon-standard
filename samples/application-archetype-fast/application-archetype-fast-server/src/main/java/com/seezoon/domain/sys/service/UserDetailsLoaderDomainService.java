...
import com.seezoon.infrastructure.security.UserGrantedAuthority;
...
public class UserDetailsLoaderDomainService implements UserDetailsLoader {
    ...
    public UserInfoDetails loadByUserId(Integer userId) {
        ...
        if (!UserStatus.valid(sysUserPO.getStatus())) {
