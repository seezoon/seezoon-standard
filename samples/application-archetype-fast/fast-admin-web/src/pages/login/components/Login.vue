<template>
  ...
  >
    ...
    <template v-else-if="type == 'qrcode'">
      ...
      <qrcode-vue :size="192" level="H" value=""/>
    </template>

    <!-- 手机号登陆 -->
    <template v-else>
      <t-form-item name="phone">
        <t-input v-model="formData.phone" placeholder="请输入手机号码" size="large">
          <template #prefix-icon>
            <t-icon name="mobile"/>
          </template>
        </t-input>
      ...
      <t-form-item class="verification-code" name="verifyCode">
        ...
        <t-button :disabled="countDown > 0" variant="outline" @click="sendCode">
