<template>
  <div :class="layoutCls">
    <t-head-menu :class="menuCls" :theme="theme" :value="active" expand-type="popup">
      ...
      <menu-content v-show="layout !== 'side'" :nav-data="menu" class="header-menu"/>
      <template #operations>
        <div class="operations-container">
          ...
          <t-dropdown :min-column-width="135" trigger="click">
            <template #dropdown>
              <t-dropdown-menu>
                <t-dropdown-item class="operations-dropdown-container-item" @click="handleNav('/sys/user/center')">
...
const navToGitHub = () => {
  window.open('https://github.com/seezoon/seezoon-standard');
};
</script>
