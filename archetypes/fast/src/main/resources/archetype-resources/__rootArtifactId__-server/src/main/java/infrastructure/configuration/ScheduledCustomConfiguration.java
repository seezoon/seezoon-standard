...
import ${package}.infrastructure.properties.SeezoonProperties.ScheduledProperties;
 ...
 * 定时配置可选
 * 
 * @see <a>https://docs.spring.io/spring-boot/docs/2.4.5/reference/htmlsingle/${symbol_pound}boot-features-task-execution-sch</a>
