...
public class JwtTokenProvider {
    ...
    /**
     * 生成token ,如果需要放其他扩展body信息，使用{@link JwtBuilder${symbol_pound}setClaims(Map)},如果需要放入header
     * 信息比如版本号{@link JwtBuilder${symbol_pound}setHeader(Map)}
     *
     * @param jwtInfo
     * @param expireSeconds
     * @return
    ...
    private Jws<Claims> parseToken(String token) {
        ...
        try {
            Jws<Claims> claimsJws = Jwts.parserBuilder()
                // https://github.com/jwtk/jjwt${symbol_pound}json-jackson-custom-types
