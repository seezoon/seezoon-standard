...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.infrastructure.file;
...
public class LocalFileHandler implements FileHandler {
    ...
    private SeezoonProperties.UploadProperties uploadProperties;

    public LocalFileHandler(SeezoonProperties.UploadProperties uploadProperties) {
        Assert.hasText(uploadProperties.getDirectory(), "FileProperties.LocalProperties directory must not be empty");
     ...
     * @param relativePath
     * @param contentType
     * @param in 会被关闭{@link FileUtils${symbol_pound}copyInputStreamToFile(InputStream, File)}
     * @throws IOException
     */
    @Override
    ...
    public InputStream download(String relativePath) throws IOException {
        ...
        if (!Files.exists(storePath)) {
            throw ExceptionFactory.bizException(ErrorCode.FILE_NOT_EXISTS.code(), ErrorCode.FILE_NOT_EXISTS.msg());
        }
