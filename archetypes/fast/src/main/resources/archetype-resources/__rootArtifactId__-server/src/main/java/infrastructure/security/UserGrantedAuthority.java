 ...
 *     &${symbol_pound}64;Secured({"ROLE_admin"}) 非常不建议使用，不是很灵活
 *      &${symbol_pound}64;PreAuthorize("hasAuthority('ROLE_admin')")
 *      &${symbol_pound}64;PreAuthorize("hasAuthority('sys:user:add')")
 *      &${symbol_pound}64;PreAuthorize("hasRole('admin')")
 * </code>
 *
 * @author hdf
 */
